...
public interface MemberRepository extends JpaRepository<Member, Long>, MemberRepositoryCuston {
    ...
    @Modifying(clearAutomatically = true) // == executeUpdate ( em.clear ) 영속성 데이터를 저장해 db와 데이터 통일
    ...
    @Override
    @EntityGraph(attributePaths = {"team"}) // == 간단한 left join fetch
    List<Member> findAll();
